...
public class GeometricCalculatorCalculateDestinationAngleTest {
	...
	public void calculateDestinationAngleTest() {
		double result = GemoetricCalculator.calculateAngle.apply(new Position(6, 5), new Position(14, 11));
		assertEquals(0.204, result, 0.01);
	}
	
	@Test
	public void calculateDestinationAngleTest2() {
		double result = GemoetricCalculator.calculateAngle.apply(new Position(-4.960573506572389, 0.6266661678215222), new Position(5, 5));
//		cod.i(result);
	...
	public void calculateDestinationAngleTestRT() {
		double result = GemoetricCalculator.calculateAngle.apply(new Position(2, 2), new Position(3, 3));
		assertEquals(0.25, result, 0.01);
	}

	@Test
	public void calculateDestinationAngleTestT() {
		double result = GemoetricCalculator.calculateAngle.apply(new Position(2, 2), new Position(2, 3));
		assertEquals(0.5, result, 0.01);
	}

	@Test
	public void calculateDestinationAngleTestLT() {
		double result = GemoetricCalculator.calculateAngle.apply(new Position(2, 2), new Position(1, 3));
		assertEquals(0.75, result, 0.01);
	}

	@Test
	public void calculateDestinationAngleTestL() {
		double result = GemoetricCalculator.calculateAngle.apply(new Position(2, 2), new Position(1, 2));
		assertEquals(1.0, result, 0.01);
	}

	@Test
	public void calculateDestinationAngleTestR() {
		double result = GemoetricCalculator.calculateAngle.apply(new Position(2, 2), new Position(3, 2));
		assertEquals(0.0, result, 0.01);
	}

	@Test
	public void calculateDestinationAngleTestLB() {
		double result = GemoetricCalculator.calculateAngle.apply(new Position(2, 2), new Position(1, 1));
		assertEquals(1.25, result, 0.01);
	}

	@Test
	public void calculateDestinationAngleTestB() {
		double result = GemoetricCalculator.calculateAngle.apply(new Position(2, 2), new Position(2, 1));
		assertEquals(1.5, result, 0.01);
	}

	@Test
	public void calculateDestinationAngleTestRB() {
		double result = GemoetricCalculator.calculateAngle.apply(new Position(2, 2), new Position(3, 1));
