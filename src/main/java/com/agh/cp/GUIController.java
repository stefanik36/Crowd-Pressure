...
public class GUIController implements Initializable {
    ...
    private com.agh.cp.model.map.Map map;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        map = new com.agh.cp.model.map.Map(engine.getEnvironment().getMap().getWalls());
    ...
    private void setWall(Position pos1, Position pos2) {
        ...
        map = new com.agh.cp.model.map.Map(currentWalls);
        drawMap(map);
